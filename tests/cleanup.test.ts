...
/**
 * The cleanup job's one decision -- "is this object orphaned" -- is the one
 * that can destroy someone's work if it's wrong, so it's exercised directly
 * against the dev store rather than mocked.
 */
